            ...
            <div className="flex flex-col space-y-40 max-w-6xl mx-auto">
                ...
                <div className="flex w-full items-center">
                    ...
                    <div className="w-1/2 text-lg">
                        ...
                        <ul className="list-disc list-inside mt-2 pl-6">
                            <li>
                                Name and email address (if you sign up for an
                                account).
                            </li>
                            <li>
                                Mood, preferences, and painting-related input.
                            </li>
                ...
                <div className="flex w-full items-center">
                    ...
                    <div className="w-1/2 text-lg">
                        ...
                        limited data with trusted third-party services (e.g.
                        OpenAI for prompt generation), solely to operate the
                        app.
                    </div>
                </div>
                ...
                <div className="flex w-full items-center">
                    ...
                    <div className="w-1/2 text-lg">
                        ...
                        <br></br>
                        You can delete your account or request deletion of your
                        data at any time. We retain data only as long as
                        necessary to support your use of the app.
                    </div>
                </div>
                ...
                <div className="flex w-full items-center">
                    ...
                    <div className="w-1/2 text-lg">
                        ...
                        However, no system is completely secure, so we encourage
                        you to use strong passwords and be mindful of the
                        content you share.
                    </div>
                </div>
            </div>
