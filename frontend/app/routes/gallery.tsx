...
export default function Gallery() {
    ...
    const handlePublishExisting = async (imagePath: string) => {
        ...
        try {
            ...
            const res = await fetch(
                `${API_BASE}/api/gallery/publish?currentUser=${encodeURIComponent(
                    username
                )}`,
                {
                    method: "POST",
    ...
    const handleDeleteExisting = async (imagePath: string) => {
        ...
        try {
            ...
            const res = await fetch(
                `${API_BASE}/api/gallery/delete?currentUser=${encodeURIComponent(
                    username
                )}`,
                {
                    method: "POST",
            ...
            <div className="p-6 sm:p-8 font-sans bg-[#F5F3FF] min-h-screen">
                ...
                <section className="mb-16 text-center">
                    ...
                    <p className="text-gray-600 mb-6">
                        Scroll through your collection of creations and compare
                        your progress.
                    </p>
                                ...
                                >
                                    ...
                                    <div className="mt-4 flex gap-3 justify-center">
                                        {!isPublished && (
                                            <button
                                                onClick={() =>
                                                    handlePublishExisting(
                                                        art.imagePath
                                                    )
                                                }
                                                disabled={
                                                    loadingAction ===
                                                    art.imagePath + "-publish"
                                                }
                    ...
                    <div className="max-w-md mx-auto bg-white border border-gray-200 rounded-xl shadow-md p-6">
                        ...
                        <div className="flex items-center justify-center gap-3 mb-4">
                            ...
                            <button
                                type="button"
                                onClick={() =>
                                    setPublishSelected(!publishSelected)
                                }
                                className="px-6 py-2 rounded-full shadow-sm font-semibold transition"
                                style={
                                    publishSelected
