...
const Home: React.FC = () => {
  ...
  const lastCommunityImageRef = React.useCallback(
    (node: HTMLDivElement | null) => {
      ...
      communityObserver.current = new window.IntersectionObserver((entries) => {
        ...
        {[1, 2, 3, 4, 5].map((star) => (
          <span
            ...
            style={{
              ...
              color: (hover || value) >= star ? "#f5b301" : "#ccc",
              fontSize: 22,
            }}
  ...
  return (
  <div className="relative flex h-screen overflow-hidden font-sans" style={{ background: "#fff", color: textColor, zIndex: 1 }}>
      <ArtBackground />
      {/* Prompt Section */}
      <div className="flex-1 px-16 py-10 transition-all duration-300 relative">
        <div className="max-w-3xl mx-auto min-h-[calc(100vh-120px)] relative">
          <div className="text-center mb-12 pt-6">
            ...
            <p className="text-md italic" style={{ color: buttonBg }}>
              🎨 Tip: Mixing colors leads to unexpectedly beautiful results.
            </p>
          </div>
                ...
                return mood !== "Other..." ? (
                  <button
                    ...
                    onClick={() => {
                      ...
                      setTimeout(() => {
                        setShowMoodOptions(false);
                        setTimeout(() => setMoodOptionsVisible(false), 500); // match fade duration
                      }, 1000);
                    }}
                  >
                    {mood}
          ...
          >
            ...
            {showPromptError && _message && (
              <div className="mt-2 text-red-600 font-semibold">{_message}</div>
            )}
          </div>
    ...
    Sign Out
      ...
      >
        <div className="flex flex-col h-full p-4">
          ...
          >
            <h2 className="text-xl font-semibold mb-2">Community Ratings</h2>
            <p className="text-sm mb-6" style={{ color: "#E0E7FF" }}>
                ...
                >
                  ...
                  >
                    <StarRating
                      value={img.avgRating}
                      onChange={(rating) =>
                        handleCommunityRate(img.username, img.imagePath, rating)
                      }
                    ...
                    >
                      {img.ratingCount > 0 ? `(${img.ratingCount})` : ""}
                    </span>
                  </div>
                </div>
              );
